...
const TeamFeedback = ({ data, handleAnswers, showAnswers, feedbackShown }) => {
  
  return (
    <div className="teamfeedbackContainer">
      <h3 className="teamFeedbackTitle">Team Feedback</h3>
      <div className="feedbacksDisplayed">
        <h5 className="teamFeedbackH5">Feedback Received</h5>
